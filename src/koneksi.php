...
/*
	Constant variable koneksi ke database
 */
...
/*
	Membuat instance untuk mysql client
 */
try {
...
/*
	Fungsi yang untuk mendapatkan estimasi 
	beberapa lama waktu yang telah lewat 
...
/*
	fungsi untuk melakukan validasi terhadap data request
	terinspirasi dari validasi laravel
	contoh paramter:
	$validatedData = validate($_POST, [
		"nama" => "required|string|min:2|max:8|"
	])
 */
...
/*
	Fungsi agar input tidak ada celah untuk XSS
 */
